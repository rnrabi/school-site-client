...
const MeetTeacher = () => {
    return (
        <>
            <div>
                <h2 className='text-2xl font-semibold text-center mt-10 py-10'>Meet Our Teacher</h2>
                <Swiper
                    slidesPerView={3}
                    spaceBetween={30}
                    freeMode={true}
                ...
                >
                    <SwiperSlide>
                        <div className="flex flex-col justify-center max-w-xs p-2 shadow-md rounded-xl sm:px-12 md:p-1 dark:bg-gray-50 dark:text-gray-800">
                            <img src="/images/about3.jpg" alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
                            <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                                <div className="my-2 space-y-1">
                                    <h2 className="text-xl font-semibold sm:text-2xl">Leroy Jenkins</h2>
                                    <p className="px-5 text-xs sm:text-base dark:text-gray-600">Full-stack developer Lorem ipsum dolor sit amet consectetur adipisicing elit. At, dolor. </p>
                                </div>
