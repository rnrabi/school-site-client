...
const WhyChoose = () => {
    return (
        <div>
            <h2 className='text-2xl font-semibold text-center mt-10'>Why choose us</h2>
            <p className='text-center'>We have strict criteria when selecting our teachers; they must be native English speakers with a higher degrees and most importantly.</p>
